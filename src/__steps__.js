 ...
 * 6. create log in and sign up route
 */
 ...
 * 1. firebase init
 * 2. proceed 
 * 3. hosting: firebase (up and down) use space bar to select
 * 4. existing project 
 * 5. select the project carefully
 * 6. which project as public directory: (vite/dist) or (create react app / build)
